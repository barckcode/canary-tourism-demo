...
const fakeClusters = [
  {
    ...
    top_nationalities: [{ nationality: "German", percentage: 45.2 }],
    top_accommodations: [{ type: "Hotel", percentage: 60.0 }],
  ...
  },
  {
    ...
    top_nationalities: [{ nationality: "British", percentage: 38.5 }],
    top_accommodations: [{ type: "Resort", percentage: 55.0 }],
    top_activities: ["Golf"],
